...
Bot em Python que automatiza a publicação de ofertas de afiliado em um canal do Telegram, com rodízio contínuo, persistência de dados e deploy 24/7 na nuvem. Tecnologias: Python, python-telegram-bot, Railway

[📁 Spaceshi.py](https://github.com/Nametala/Spaceshi.py)
Jogo de nave espacial desenvolvido em dupla, onde o jogador desvia e destrói asteroides enquanto a pontuação cresce com o tempo. Tecnologias: Python, Pygame, Pytest
